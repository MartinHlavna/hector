...
**Najnovšia testovacia verzia:** [v 0.11.2 beta](https://github.com/MartinHlavna/hector/releases/tag/v.0.11.2-beta)

### Súbory:

| Súbor | Stiahnuť |
|------|----------|
| hector-linux-amd64.bin | [Download](https://github.com/MartinHlavna/hector/releases/download/v.0.11.2-beta/hector-linux-amd64.bin) |
| hector-windows-amd64-debug.exe | [Download](https://github.com/MartinHlavna/hector/releases/download/v.0.11.2-beta/hector-windows-amd64-debug.exe) |
| hector-windows-amd64.exe | [Download](https://github.com/MartinHlavna/hector/releases/download/v.0.11.2-beta/hector-windows-amd64.exe) |
