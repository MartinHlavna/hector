...
if "NUITKA_ONEFILE_PARENT" in os.environ:
    ...
    RUN_DIRECTORY = os.path.dirname(os.path.dirname(os.path.dirname(__file__)))
...
THESAURUS=os.path.join(SK_DICTIONARY_DIR, "th_sk_SK_v2.dat")
SK_SPELL_DICTIONARY_DIR = os.path.join(DICTIONARY_DIR, "sk-skspell")
SK_SPELL_AFF=os.path.join(SK_SPELL_DICTIONARY_DIR, "sk_SK.aff")
SK_SPELL_DIC=os.path.join(SK_SPELL_DICTIONARY_DIR, "sk_SK.dic")
